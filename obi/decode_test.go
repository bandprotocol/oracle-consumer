...
func TestDecodeSlice(t *testing.T) {
	var actual []int32
	byteArray, _ := hex.DecodeString("00000006000000010000000200000003000000040000000500000006")
	MustDecode(byteArray, &actual)
...
func TestDecodeStruct(t *testing.T) {
	...
	byteArray, _ := hex.DecodeString("000000034254430000000000002328010200000002000a000b")
	MustDecode(byteArray, &actual)
	require.Equal(t,
		ExampleData{
			Symbol: "BTC",
