...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"consumer", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"consumer", "prices", "symbol"}, "", runtime.AssumeColonVerbOpt(true)))
)
