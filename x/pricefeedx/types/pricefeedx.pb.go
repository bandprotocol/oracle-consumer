...
// source: pricefeedx/pricefeedx.proto
...
func (*Price) Descriptor() ([]byte, []int) {
	return fileDescriptor_4271c640ba6a5e17, []int{0}
}
...
func (*SymbolRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4271c640ba6a5e17, []int{1}
}
...
func (*UpdateSymbolRequestProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_4271c640ba6a5e17, []int{2}
}
...
func init() {
	proto.RegisterType((*Price)(nil), "pricefeedx.Price")
	proto.RegisterType((*SymbolRequest)(nil), "pricefeedx.SymbolRequest")
	proto.RegisterType((*UpdateSymbolRequestProposal)(nil), "pricefeedx.UpdateSymbolRequestProposal")
}

func init() { proto.RegisterFile("pricefeedx/pricefeedx.proto", fileDescriptor_4271c640ba6a5e17) }

var fileDescriptor_4271c640ba6a5e17 = []byte{
	// 369 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Price) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ResolveTime != 0 {
		i = encodeVarintPricefeedx(dAtA, i, uint64(m.ResolveTime))
		i--
		dAtA[i] = 0x18
	}
	if m.Price != 0 {
		i = encodeVarintPricefeedx(dAtA, i, uint64(m.Price))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Symbol) > 0 {
		...
		i = encodeVarintPricefeedx(dAtA, i, uint64(len(m.Symbol)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *SymbolRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BlockInterval != 0 {
		i = encodeVarintPricefeedx(dAtA, i, uint64(m.BlockInterval))
		i--
		dAtA[i] = 0x18
	}
	if m.OracleScriptId != 0 {
		i = encodeVarintPricefeedx(dAtA, i, uint64(m.OracleScriptId))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Symbol) > 0 {
...
func (m *UpdateSymbolRequestProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.SymbolRequests) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintPricefeedx(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x1a
		}
	...
	if len(m.Description) > 0 {
		...
		i = encodeVarintPricefeedx(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintPricefeedx(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintPricefeedx(dAtA []byte, offset int, v uint64) int {
	offset -= sovPricefeedx(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Price) Size() (n int) {
	...
	l = len(m.Symbol)
	if l > 0 {
		n += 1 + l + sovPricefeedx(uint64(l))
	}
	if m.Price != 0 {
		n += 1 + sovPricefeedx(uint64(m.Price))
	}
	if m.ResolveTime != 0 {
		n += 1 + sovPricefeedx(uint64(m.ResolveTime))
	}
	return n
}
...
func (m *SymbolRequest) Size() (n int) {
	...
	if m.OracleScriptId != 0 {
		n += 1 + sovPricefeedx(uint64(m.OracleScriptId))
	}
	if m.BlockInterval != 0 {
		n += 1 + sovPricefeedx(uint64(m.BlockInterval))
	}
	return n
}
...
func sovPricefeedx(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozPricefeedx(x uint64) (n int) {
	return sovPricefeedx(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Price) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowPricefeedx
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthPricefeedx
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipPricefeedx(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipPricefeedx(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowPricefeedx
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthPricefeedx
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupPricefeedx
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthPricefeedx        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowPricefeedx          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupPricefeedx = fmt.Errorf("proto: unexpected end of group")
)
